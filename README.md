...
When color varies significantly across frames in the input, it is better to create one palette per frame; better quality GIF, heavier file (although still lighter than using no palette at all):
